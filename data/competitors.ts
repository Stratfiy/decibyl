...
export const competitors: Competitor[] = [
  ...
  },
  {
    ...
    table: sharedTable({
      ...
      residency: 'India',
      mcp: 'No',
      costModel: 'Bundled into plan and per-minute telephony rates; provider-key support is not published',
  ...
  },
  {
    ...
    table: sharedTable({
      ...
      residency: 'India',
      mcp: 'No',
      costModel: 'Bundled into plan and add-on pricing; provider-key support is not offered',
  ...
  },
  {
    ...
    table: sharedTable({
      ...
      mcp: 'No',
      costModel: 'Custom quote — platform fee, conversation charges and services not itemised publicly; provider-key support is not published',
