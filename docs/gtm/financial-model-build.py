...
inp("ads_1", "Ads budget months 1 to 6, ₹/month", 50000, INR, "Assumption")
inp("ads_2", "Ads budget months 7 to 12, ₹/month", 150000, INR, "")
inp("ads_3", "Ads budget months 13 to 24, ₹/month", 300000, INR, "")
...
inp("champ_retainer", "Champion retainer, ₹/month each", 20000, INR, "₹15k to ₹25k")
...
sec("Team")
inp("pay_1", "Payroll months 1 to 6, ₹/month", 300000, INR, "Assumption: 2 engineers + founder minimal; edit")
inp("pay_2", "Payroll months 7 to 12, ₹/month", 450000, INR, "")
inp("pay_3", "Payroll months 13 to 24, ₹/month", 700000, INR, "")
