...
export default async function CityPage({ params }: { params: Promise<{ city: string }> }) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: `In India — AWS Mumbai, ap-south-1 — and nowhere else. Every call is transcribed and recorded, and QA scoring can be run on all of them. Decibyl is not ISO 27001, SOC 2 or HIPAA certified, and says so plainly on its security page.`,
    },
  ];
