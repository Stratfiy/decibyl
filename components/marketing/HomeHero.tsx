        ...
        <div className={styles.demo} aria-label="Decibyl agent completing work">
          ...
          <div className={styles.workCard}>
            ...
            <div className={styles.thread}>
              ...
              <div className={styles.agentBubble}>I found the last conversation, checked the CRM and drafted the follow-up.</div>
            </div>
          ...
          <div className={styles.floatCard} data-side="left">
            <span>VOICE</span><strong>Call completed</strong><small>Lead qualified · 2m 14s</small>
          </div>
