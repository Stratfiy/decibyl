...
const sharedVisibility = [
  ...
  'QA scoring on every call, on by default — not a 2% sample',
  ...
  // ─────────────────────────────────────────────────── Lending & collections
  {
    ...
    objections: [
      ...
      },
      {
        ...
        a: 'All of them. Full recordings and full transcripts on every call, and a QA score on every one, on by default — which is a stronger audit position than sampled human QA.',
      },
      {
    ...
    seo: {
      ...
      description:
        'On-script EMI reminder and soft-recovery calls, recorded and transcribed in full with QA scoring on every call by default, and human transfer on any dispute or hardship.',
      keywords: [
  ...
  // ────────────────────────────────────────────────────────────── Logistics
  {
    ...
    objections: [
      ...
      },
      {
        ...
        a: 'Yes — recording and transcript on every call, and a QA score on all of them without you configuring anything. That is usually the reason operators buy it: it settles the fake-NDR argument with evidence.',
      },
    ],
    visibility: sharedVisibility,
    recommendedTier: 'growth',
